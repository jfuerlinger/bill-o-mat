...
namespace BillOMat.Api.Test.Features.Patients
{
    public class CreatePatientCommandHandlerTests
    {
        ...
        [Fact]
        [UnitTest]
        public async Task Handle_ShouldReturnValidationFailure_WhenEmailIsNotUniqe()
        {
            // Arrange
        ...
        [Fact]
        [UnitTest]
        public async Task Handle_ShouldReturnNoValidationFailures_WhenEverythingIsOk()
        {
            // Arrange
            var command = new CreatePatient.Command()
            {
            ...
            // Assert
            result.Match<object>(
                patientId => patientId.Should().Be(0),
